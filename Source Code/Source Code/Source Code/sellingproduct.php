...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE selling_product SET  `category_id`='$_POST[category]', `product_name`='$_POST[productname]', `product_description`='$_POST[productdescription]',";
		if($_FILES['img1']['name'] != "")
		$sql = $sql . " `product_img1`='$imgname1', ";
		if($_FILES['img2']['name'] != "")
		$sql = $sql . " `product_img2`='$imgname2', ";
		if($_FILES['img3']['name'] != "")
		$sql = $sql . " `product_img3`='$imgname3', ";
		if($_FILES['img4']['name'] != "")
		$sql = $sql . " `product_img4`='$imgname4', ";
		if($_FILES['img5']['name'] != "")
		$sql = $sql . " `product_img5`='$imgname5', ";
		$sql = $sql . " `cost`='$_POST[cost]',`quantity_type`='$_POST[quantitytype]', `status`='$_POST[status]' WHERE selling_prod_id='$_GET[editid]'";
  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Enter Farmer's Kit record...</h4></center><hr>

<form  method="post" action="" enctype="multipart/form-data" name="frmsellingproduct" onSubmit="return validatesellingproduct()">
<?php
if(isset($_GET['editid'])) {
?>
	<input type="hidden" name="selling_prod_id" id="selling_prod_id" value="<?php echo $_GET['editid']; ?>" >
<?php } else { ?>
	<input type="hidden" name="selling_prod_id" id="selling_prod_id" value="0" >
<?php } ?>
...
<div class="form-row">
	...
	Image 1 (Primary image) <font color="#FF0000">*</font>
	  <input type="file" name="img1" id="img1" class="form-control">
	  	<?php
		if(isset($_GET['editid'])) {
			if(file_exists("imgsellingproduct/$rsedit[product_img1]") && $rsedit['product_img1'] != "") {
		?>
		<img src="imgsellingproduct/<?php echo $rsedit['product_img1']; ?>" width="100px" height="100px" />
		<?php } } ?>
	</div>	
	<div class="col-md-6 form-group">
	Image 2<font color="#FF0000">*</font>
	  ...
	  <?php
		if(isset($_GET['editid'])) {
			if(file_exists("imgsellingproduct/$rsedit[product_img2]") && $rsedit['product_img2'] != "") {
		?>
		<img src="imgsellingproduct/<?php echo $rsedit['product_img2']; ?>" width="100px" height="100px" />
		<?php } } ?>
	</div>	
	<div class="col-md-6 form-group">
	Image 3<font color="#FF0000">*</font>
	  ...
	  <?php
		if(isset($_GET['editid'])) {
			if(file_exists("imgsellingproduct/$rsedit[product_img3]") && $rsedit['product_img3'] != "") {
		?>
		<img src="imgsellingproduct/<?php echo $rsedit['product_img3']; ?>" width="100px" height="100px" />
		<?php }} ?>
	</div>	
	<div class="col-md-6 form-group">
	Image 4<font color="#FF0000">*</font>
	  ...
	  <?php
		if(isset($_GET['editid'])) {
			if(file_exists("imgsellingproduct/$rsedit[product_img4]") && $rsedit['product_img4'] != "") {
		?>
		<img src="imgsellingproduct/<?php echo $rsedit['product_img4']; ?>" width="100px" height="100px" />
		<?php } } ?>
	</div>	
	<div class="col-md-6 form-group">
	Image 5<font color="#FF0000">*</font>
	  ...
	  <?php
		if(isset($_GET['editid'])) {
			if(file_exists("imgsellingproduct/$rsedit[product_img5]") && $rsedit['product_img5'] != "") {
		?>
		<img src="imgsellingproduct/<?php echo $rsedit['product_img5']; ?>" width="100px" height="100px" />
		<?php } } ?>
	</div>
	...
	Cost <font color="#FF0000">*</font>
	  <input type="number" name="cost" id="cost" value="<?php echo intval($rsedit['cost']); ?>" class="form-control" >
	</div>	
...
function validatesellingproduct()
{
	...
	else if(document.frmsellingproduct.img1.value == "" && document.frmsellingproduct.selling_prod_id.value == "0")
	{
