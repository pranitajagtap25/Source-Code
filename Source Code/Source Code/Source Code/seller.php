...
?>
    ...
    function validatesellreg() {
        ...
        var passwordExp = /^(?=.[a-z])(?=.[A-Z])(?=.\d)(?=.[@$!%?&])[A-Za-z\d@$!%?&]{8,16}$/; // Variable to validate password
        ...
        if (document.frmsellreg.sellername.value == "") {
            ...
            return false;
        } else if (document.frmsellreg.contactnumber.value.length > 15) {
            alert("Contact Number should not contain more than 15 digits.");
            document.frmsellreg.contactnumber.focus();
            return false;
        } else if (document.frmsellreg.contactnumber.value.length < 8) {
            alert("Contact Number should not contain less than 8 digits.");
            document.frmsellreg.contactnumber.focus();
            return false;
        } else if (document.frmsellreg.mbnumber.value.length != 10) {
            ...
            return false;
        } else if (!document.frmsellreg.password.value.match(passwordExp)) {
            alert("Password must be between 8 and 16 characters, and contain at least one uppercase letter, one lowercase letter, one numeric digit, and one special character.");
            document.frmsellreg.password.focus();
            return false;
            ...
            alert("Please enter only letters for bank name.");
            document.frmsellreg.bankname.focus();
            return false;
            ...
            alert("Please enter only letters for bank branch.");
            document.frmsellreg.branch.focus();
            return false;
            ...
            alert("Kindly enter a valid 11-character IFSC Code.");
            document.frmsellreg.ifsccode.focus();
            return false;
        } else if (document.frmsellreg.bankacnumber.value == "") {
            alert("Kindly enter the bank account number.");
