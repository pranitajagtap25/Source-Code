...
{
	$loginid 	= "agri@technopulse.cyou";
	$password 	= "&cses-_wiY6%";
	$smtpserver = "mail.technopulse.cyou";
	$smtpport 	= 465;
	$mailsender = "AgriTrade";
	$companyname= "AgriTrade";
	$facebook = "https://www.facebook.com/AgriTrade";
	$twitter = "https://www.twitter.com/AgriTrade";
	$youtube = "https://www.youtube.com/AgriTrade";
	$linkedin = "https://www.linkedin.com/AgriTrade";
	$companyaddress  = "AgriTrade";
	$contactno = "7894561230";
	$url = "www.AgriTrade.com";
