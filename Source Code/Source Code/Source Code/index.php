...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>कृषी सेवा - Moving ahead with agriculture </h1>
      <h2>कृषी सेवा provide a profitable and convenient way for local farmers to sell their products....</h2>
      <a href="customerreglogin.php" class="btn-get-started scrollto">Sell Your Agricultural Products</a>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-2 col-4 text-center">
            <span data-toggle="counter-up">100<?php
...
echo mysqli_num_rows($qsql);
          ...
          <div class="col-lg-2 col-4 text-center">
            <span data-toggle="counter-up">200<?php
...
echo mysqli_num_rows($qsql);
          ...
          <div class="col-lg-2 col-4 text-center">
            <span data-toggle="counter-up">1<?php
...
echo mysqli_num_rows($qsql);
          ...
          <div class="col-lg-2 col-4 text-center">
            <span data-toggle="counter-up">10<?php
...
<img src="assets/slider/pj21.jpg" style="width: 100%;">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p class="font-italic"><b>Mission :</b>  To build a profitable business, food manufacturers seek to establish a preference for their products by differentiating those products in some way which is meaningful to consumers.
            </p>
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> "कृषी सेवा" is a model farmer management website application..</li>
              <li><i class="ri-check-double-line"></i> "कृषी सेवा" provides a concept of virtual agricultur to its users.</li>
