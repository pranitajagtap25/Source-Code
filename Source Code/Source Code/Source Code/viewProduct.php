  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>View Produce Detail...</h4></center><hr>
...
<?php
						$sql = "SELECT * FROM product ";
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
							   <td><a href='Product.php?editid=$rs[product_id]' class='btn btn-info'>Edit</a><br><a href='viewProduct.php?deleteid=$rs[product_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
