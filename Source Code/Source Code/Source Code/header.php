...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>कृषी सेवा</span></a></h1>
	...
	<li class="drop-down"><a href="#">Articles</a>
	  <ul>
			<li><a href="displayarticles.php?articletype=Blog">Blogs</a></li>
...
<li class="drop-down <?php
  ...
  <ul>
    ...
    <li><a href="viewpurchaserequest.php">Farmer's Market - View Purchase request</a></li>
    <li><a href="viewcstpurchaseorder.php">Farmer's Market - View Purchase Order</a></li>
    <li><a href="viewpurchasereport.php">Farmer's Market - View Billing Report</a></li>
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li class="drop-down"><a href="#">Report</a>
	  <ul>
		<li><a href="viewcustomerReg.php">Customer Account Report</a></li>      
		<li><a href="viewseller.php">Farmer Account Report</a></li>
		<li><a href="viewadminpurchasereport.php">Farmer's Kit -  Product Billing Report</a></li>
		<li><a href="viewSellingProduce.php">Farmer's Market -  Produce Report</a></li>
		<li><a href="viewadminpurchaserequest.php">Farmer's Market -  Produce Purchase Request</a></li>
		<li><a href="viewpurchasereport.php">Farmer's Market -  Produce  Billing Report</a></li>
	  </ul>
	</li>
...
<li><a href="viewworkerrequest.php">View Worker Request</a></li>
	...
	<li class="drop-down"><a href="#">Farmer's Kit</a>
	  <ul>
		<li><a href="sellingproduct.php">Add  Farmer's Kit product</a></li>
		<li><a href="viewsellingproduct.php">View  Farmer's Kit product</a></li>
		<li><a href="category.php?cattype=SellingProduct">Add Farmer's Kit Category</a></li>     
		<li><a href="viewcategory.php?cattype=SellingProduct">View Farmer's Kit Category</a></li>  
	  </ul>
	</li>
