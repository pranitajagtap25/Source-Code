    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row">
          ...
          <center><h1 class="text-light"><a href="index.php"><span>Krushi Seva</span></a></h1></center>
...
<hr>
<center><a href="salesprintbillprint.php?purchase_order_bill_id=<?php echo $_GET['purchase_order_bill_id']; ?>" target="_blank" autofocus class="btn btn-primary">Print Bill</a></center>
                </div>
              </div>
            </form>
          </div>
