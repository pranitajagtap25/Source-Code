                        ...
                        <div class="col-md-9 d-flex align-items-stretch">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;text-align: left;">
                                <form method="post" action="" enctype="multipart/form-data" name="frmworkreg" onSubmit="return validateworkreg()">
                                    ...
                                    <input type="hidden" name="editid" id="editid" value="<?php echo isset($_GET['editid']) ? $_GET['editid'] : 0; ?>">
...
<script type="application/javascript">
    function validateworkreg() {
        ...
        var passwordExp = /^(?=.\d)(?=.[a-z])(?=.*[A-Z]).{8,16}$/; //Variable to validate password complexity
        ...
        if (document.frmworkreg.name.value == "") {
            ...
            return false;
        } else if (!document.frmworkreg.password.value.match(passwordExp)) {
            alert("Password must be between 8 to 16 characters and include at least one numeric digit, one uppercase and one lowercase letter..");
            document.frmworkreg.password.focus();
            return false;
            ...
            document.frmworkreg.expectedsalary.focus();
            return false;
        } else {
            return true;
        }
