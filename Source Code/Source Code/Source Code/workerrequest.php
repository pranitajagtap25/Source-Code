...
<?Php
$yr =  date('Y');
$start_year= $yr - 1; // Starting year for dropdown list box
$end_year= $yr + 2;  // Ending year for dropdown list box
?>
<?Php
...
<div class="form-row">
	...
	From Date <font color="#FF0000">*</font>
	  <input type="date" name="fromdate" id="fromdate" min="<?php echo date('Y-m-d', strtotime(date("Y-m-d") . ' + 1 day')); ?>" value="<?php echo $rsedit['from_date']; ?>" autofocus class="form-control">
	</div>	
	
	<div class="col-md-6 form-group">
		Till Date <font color="#FF0000">*</font>
	  <input type="date" name="tilldate" id="tilldate" min="<?php echo date('Y-m-d', strtotime(date("Y-m-d") . ' + 1 day')); ?>"  value="<?php echo $rsedit['to_date']; ?>" class="form-control">
	</div>	
	...
	<div class="col-md-6 form-group">
	  ...
	  <input type="number" name="salary" id="salary" min="1" value="<?php echo $rsedit['salary']; ?>" class="form-control">
	</div>	
...
$("#fromdate").change(function(){
  $("#tilldate").attr('min',$("#fromdate").val());
});
